...
pub const struct_deque_node = extern struct {
    payload: c_int = @import("std").mem.zeroes(c_int),
    next: [*c]struct_deque_node = @import("std").mem.zeroes([*c]struct_deque_node),
    prev: [*c]struct_deque_node = @import("std").mem.zeroes([*c]struct_deque_node),
};
pub const deque_node = struct_deque_node;
pub const struct_deque = extern struct {
    first: [*c]struct_deque_node = @import("std").mem.zeroes([*c]struct_deque_node),
    last: [*c]struct_deque_node = @import("std").mem.zeroes([*c]struct_deque_node),
    length: c_int = @import("std").mem.zeroes(c_int),
};
pub const deque = struct_deque;
pub extern fn init_deque(...) [*c]deque;
pub extern fn deque_pop_front(input: [*c]deque) c_int;
pub extern fn deque_pop_back(input: [*c]deque) c_int;
pub extern fn deque_push_front(input: [*c]deque, val: c_int, print: c_int) void;
pub extern fn deque_push_back(input: [*c]deque, val: c_int, print: c_int) void;
pub extern fn print_deque(input: [*c]deque) void;
pub extern fn free_deque(input: [*c]deque) void;
